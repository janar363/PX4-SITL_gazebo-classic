...
namespace gazebo {
    ...
    WindDataProcessor::Array3D arr("../../../Tools/sitl_gazebo/include/data_processor/wisp_50.csv", "../../../Tools/sitl_gazebo/include/data_processor/3darr.bin", -25, 25, -25, 25, 0, 10);
